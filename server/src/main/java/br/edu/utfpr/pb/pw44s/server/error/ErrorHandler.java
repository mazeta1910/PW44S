...
public class ErrorHandler implements ErrorController {
    ...
    private final ErrorAttributes errorAtributes;

    public ErrorHandler(ErrorAttributes errorAttributes) {
        this.errorAtributes = errorAttributes;
    }

    @RequestMapping("error")
    public ApiError handleError(WebRequest webRequest, HttpServletResponse response) {
        Map<String, Object> attributes = errorAtributes.getErrorAttributes(webRequest, ErrorAttributeOptions.of(ErrorAttributeOptions.Include.MESSAGE));
